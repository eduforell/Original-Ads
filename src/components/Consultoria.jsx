        ...
        <>
            <div className='mb-20'>
                <div className="w-full md:w-3/5 py-12 md:p-8 mt-16 md:mt-4 p-8">
                    <h2 className="w-full md:text-2xl h2-bold mb-4 text-dark-4">Consultoria</h2>
                            ...
                            <div className=" min-w-[240px] md:max-w-[260px] p-6 border border-gray-900 rounded-[10px]">
                                ...
                                <div className="flex flex-col justify-center items-center gap-4 mt-5">
                                    {categoria.logos.map((logo, index) => (
                                        <img key={index} src={logo} alt={`Logo ${categoria.titulo} ${index + 1}`} className="max-w-20 mx-2" />
                                    ))}
                                </div>
                            </div>
                        </div>
