...
const CTAMediaKit = () => {
    return (
        <div className="bg-original-dark flex flex-col items-center justify-center h-[300px]">
            ...
            <a href="../assets/images/Deck_OriginalAds_2024.pdf" download>
                <button className="bg-original text-dark-3 hover:bg-original-h py-4 px-8 rounded-[32px] flex flex-row items-center gap-2">
